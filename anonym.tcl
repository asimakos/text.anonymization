...
#  Mar 20, 2020 09:01:26 PM EET  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top43 {base} {
    ...
    wm deiconify $top
    wm title $top "Anonymization  textual  data"
    ...
    vTcl:DefineAlias "$top.scr52" "Scrolledtext1" vTcl:WidgetProc "Toplevel1" 1
    ...
    vTcl::widgets::ttk::scrolledtext::CreateCmd $top.scr44 \
        ...
        -height 75 -highlightbackground $vTcl(actual_gui_bg) \
        -highlightcolor black -width 125 
    vTcl:DefineAlias "$top.scr44" "Scrolledtext2" vTcl:WidgetProc "Toplevel1" 1
    ...
    ###################
    place $top.but46 \
        -in $top -x 0 -relx 0.344 -y 0 -rely 0.491 -width 137 -relwidth 0 \
        -height 34 -relheight 0 -anchor nw -bordermode ignore 
    place $top.but47 \
        -in $top -x 0 -relx 0.651 -y 0 -rely 0.491 -width 0 -relwidth 0.127 \
        -height 0 -relheight 0.043 -anchor nw -bordermode ignore 
    place $top.scr52 \
        -in $top -x 0 -relx 0.028 -y 0 -rely 0.063 -width 0 -relwidth 0.952 \
        -height 0 -relheight 0.409 -anchor nw -bordermode ignore 
    place $top.scr44 \
        -in $top -x 0 -relx 0.028 -y 0 -rely 0.553 -width 0 -relwidth 0.952 \
        -height 0 -relheight 0.409 -anchor nw -bordermode ignore 
    place $top.lab45 \
        -in $top -x 0 -relx 0.028 -y 0 -rely 0.025 -width 0 -relwidth 0.127 \
        -height 0 -relheight 0.026 -anchor nw -bordermode ignore 
    place $top.lab46 \
        -in $top -x 0 -relx 0.028 -y 0 -rely 0.516 -width 0 -relwidth 0.099 \
        -height 0 -relheight 0.026 -anchor nw -bordermode ignore 
